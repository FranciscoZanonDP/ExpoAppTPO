import { StyleSheet, View, SafeAreaView, TouchableOpacity, TextInput, Button, Alert } from 'react-native';
...
export default function VerificationScreen() {
    ...
    const handleVerify = async () => {
        // Simulación: el código correcto es '123456'
        if (codigo !== '123456') {
        ...
        setLoading(true);
        try {
            const response = await fetch('https://expo-app-tpo.vercel.app/api/register', {
                method: 'POST',
